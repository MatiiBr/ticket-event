...
contract EventFactory {
    ...
    */
    function createEvent(
        ...
        data.eventTickets = new DefaultEventTickets(_description, _url,_totalTickets,_ticketPrice);
        quantity++;
    }
    ...
    */
    function getEvent(uint256 id) external view returns (EventData memory) { return events[id];}
}
